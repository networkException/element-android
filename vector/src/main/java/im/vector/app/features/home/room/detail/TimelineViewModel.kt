...
import im.vector.app.features.raw.wellknown.getOutboundSessionKeySharingStrategy
...
class TimelineViewModel @AssistedInject constructor(
    ...
    init {
        ...
        if (room.roomCryptoService().isEncrypted()) {
            viewModelScope.withElementWellKnown(rawService, session.sessionParams) {
                val strategy = it.getOutboundSessionKeySharingStrategy()
